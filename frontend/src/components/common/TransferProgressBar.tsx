...
function CircularRing({ percentage }: CircularRingProps) {
	...
	return (
		...
		>
			<defs>
				<linearGradient
					id="ring-progress-gradient"
					x1="0%"
					y1="0%"
					x2="100%"
					y2="100%"
				>
					<stop offset="0%" stopColor="var(--app-gradient-from)" />
					<stop offset="100%" stopColor="var(--app-gradient-to)" />
				</linearGradient>
			</defs>
						...
						return (
							...
							>
								<div
									...
									style={{
										backgroundImage:
											'linear-gradient(135deg, var(--app-gradient-from), var(--app-gradient-to))',
