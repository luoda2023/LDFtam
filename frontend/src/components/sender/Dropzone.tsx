	...
	const getDropzoneStyles = () => {
		...
		if (isDragActive) {
			return {
				...
				background:
					'linear-gradient(135deg, color-mix(in srgb, var(--app-gradient-from) 14%, var(--background)), color-mix(in srgb, var(--app-gradient-to) 14%, var(--background)))',
				boxShadow:
					'inset 0 0 0 2px color-mix(in srgb, var(--app-gradient-from) 75%, transparent), 0 8px 32px color-mix(in srgb, var(--app-gradient-from) 20%, transparent)',
			}
		}
